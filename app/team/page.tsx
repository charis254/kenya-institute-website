  ...
  const leadership = [
    {
      ...
      bio: "PhD in Financial Economics with 15+ years of experience in digital asset research and policy development. Former advisor to the Central Bank of Kenya on digital currency initiatives.",
      expertise: ["Digital Asset Policy", "Financial Economics", "Regulatory Frameworks"],
      education: "PhD Financial Economics, University of Cambridge",
      image: "/placeholder.svg?height=300&width=300",
      linkedin: "#",
      twitter: "#",
      email: "sarah.kimani@kidar.org",
    },
    {
      name: "Michael Ochieng",
      role: "Head of Training & Education",
      bio: "Former blockchain consultant with expertise in institutional training and curriculum development. Led digital transformation initiatives at major African financial institutions.",
      ...
      linkedin: "#",
      twitter: "#",
      email: "michael.ochieng@kidar.org",
    },
    {
      name: "Grace Wanjiku",
      role: "Director of Strategic Partnerships",
      bio: "MBA in International Business, specializing in public-private partnerships and regulatory affairs. Extensive experience in stakeholder engagement across Africa.",
      expertise: ["Strategic Partnerships", "Stakeholder Engagement", "Business Development"],
      education: "MBA International Business, INSEAD",
      image: "/placeholder.svg?height=300&width=300",
      linkedin: "#",
      twitter: "#",
      email: "grace.wanjiku@kidar.org",
    },
  ]
